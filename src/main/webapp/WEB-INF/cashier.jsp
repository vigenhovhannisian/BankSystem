...
<tbody>
<tr>
<td> <spring:form action="/change" method="post" modelAttribute="accessMoney">
    ...
    <td><spring:form action="/changer" method="post" modelAttribute="exitMoney">
        <spring:select path="moneyType">
        <option>AMD</option>
        <option>CNY</option>
        <option>EUR</option>
    ...
    <td> <spring:input path="exitMoney"></spring:input>

    <td><spring:input path="percent"></spring:input>
    <input type="submit" value="ADD">
    </spring:form></td></td></td>
    </tr>
    <tr>
    </tbody>
    </table>
